...
## Last Updated
September 26, 2026 at 02:09:20 AM UTC
...
- [Challenges of Heterogeneity in Big Data: A Comparative Study of Classification in Large-Scale Structured and Unstructured Domains](https://arxiv.org/abs/2512.00298)
- [SoftStep: Learning Sparse Similarity Powers Deep Neighbor-Based Regression](https://arxiv.org/abs/2506.08139)
- [Towards a Relationship-Aware Transformer for Tabular Data](https://arxiv.org/abs/2512.07310)
- [Detection and Localization of Subdural Hematoma Using Deep Learning on Computed Tomography](https://arxiv.org/abs/2512.09393)
- [Sequence-to-Image Transformation for Sequence Classification Using Rips Complex Construction and Chaos Game Representation](https://arxiv.org/abs/2512.10141)
- [ModSSC: A Modular Framework for Semi-Supervised Classification on Heterogeneous Data](https://arxiv.org/abs/2512.13228)
- [Residual GRU+MHSA: A Lightweight Hybrid Recurrent Attention Model for Cardiovascular Disease Detection](https://arxiv.org/abs/2512.14563)
- [Iterative Feature Exclusion Ranking for Deep Tabular Learning](https://arxiv.org/abs/2412.16442)
- [What-If Decision Support for Product Line Extension Using Conditional Deep Generative Models](https://arxiv.org/abs/2511.11646)
- [Reinforcement Learning for Monetary Policy Under Macroeconomic Uncertainty: Analyzing Tabular and Function Approximation Methods](https://arxiv.org/abs/2512.17929)
- [Robustness and Scalability Of Machine Learning for Imbalanced Clinical Data in Emergency and Critical Care](https://arxiv.org/abs/2512.21602)
...
- [Reading Between the Lines: Deconfounding Causal Estimates using Text Embeddings and Deep Learning](https://arxiv.org/abs/2601.01511)
...
- [LATTLE: LLM Attention Transplant for Transfer Learning of Tabular Data Across Disparate Domains](https://arxiv.org/abs/2511.06161)
...
- [Automated Model Design using Gated Neuron Selection in Telecom](https://arxiv.org/abs/2602.10854)
...
- [HyConEx: Hypernetwork classifier with counterfactual explanations for tabular data](https://arxiv.org/abs/2503.12525)
...
- [L2GTX: From Local to Global Time Series Explanations](https://arxiv.org/abs/2603.13065)
...
- [Stochastic Resetting Accelerates Policy Convergence in Reinforcement Learning](https://arxiv.org/abs/2603.16842)
- [Deep Tabular Representation Corrector](https://arxiv.org/abs/2603.16569)
- [A Survey on Deep Learning Approaches for Tabular Data Generation: Utility, Alignment, Fidelity, Privacy, Diversity, and Beyond](https://arxiv.org/abs/2503.05954)
...
- [SYNTHONY: A Stress-Aware, Intent-Conditioned Agent for Deep Tabular Generative Models Selection](https://arxiv.org/abs/2604.00293)
- [Learning to Play Blackjack: A Curriculum Learning Perspective](https://arxiv.org/abs/2604.00076)
...
- [Synthesizing real-world distributions from high-dimensional Gaussian Noise with Fully Connected Neural Network](https://arxiv.org/abs/2604.09091)
- [Evaluating Deep Learning Models for Multiclass Classification of LIGO Gravitational-Wave Glitches](https://arxiv.org/abs/2604.08796)
- [VOLTA: The Surprising Ineffectiveness of Auxiliary Losses for Calibrated Deep Learning](https://arxiv.org/abs/2604.08639)
- [Integrating SAINT with Tree-Based Models: A Case Study in Employee Attrition Prediction](https://arxiv.org/abs/2604.10337)
- [Interpretable Alzheimer's Diagnosis via Multimodal Fusion of Regional Brain Experts](https://arxiv.org/abs/2512.10966)
- [Beyond Statistical Co-occurrence: Unlocking Intrinsic Semantics for Tabular Data Clustering](https://arxiv.org/abs/2604.10865)
- [A Survey on Deep Learning Techniques for Action Anticipation](https://arxiv.org/abs/2309.17257)
- [MyoVision: A Mobile Research Tool and NEATBoost-Attention Ensemble Framework for Real Time Chicken Breast Myopathy Detection](https://arxiv.org/abs/2604.13456)
- [Benchmarking Optimizers for MLPs in Tabular Deep Learning](https://arxiv.org/abs/2604.15297)
- [Tree of Concepts: Interpretable Continual Learners in Non-Stationary Clinical Domains](https://arxiv.org/abs/2604.17089)
...
- [TabSurv: Adapting Modern Tabular Neural Networks to Survival Analysis](https://arxiv.org/abs/2605.03944)
- [DynaTab: Dynamic Feature Ordering as Neural Rewiring for High-Dimensional Tabular Data](https://arxiv.org/abs/2605.03430)
- [A Unified Framework for Tabular Generative Modeling: Loss Functions, Benchmarks, and Improved Multi-objective Bayesian Optimization Approaches](https://arxiv.org/abs/2405.16971)
- [ITBoost: Information-Theoretic Trust for Robust Boosting](https://arxiv.org/abs/2605.04671)
...
- [Resilient Vision-Tabular Multimodal Learning under Modality Missingness](https://arxiv.org/abs/2605.12031)
- [Multi-Dimensional Model Integrity and Responsibility Assessment Index and Scoring Framework](https://arxiv.org/abs/2605.14550)
- [From Schema to Signal: Retrieval-Augmented Modeling for Relational Data Analytics](https://arxiv.org/abs/2605.14464)
- [LoMETab: Beyond Rank-1 Ensembles for Tabular Deep Learning](https://arxiv.org/abs/2605.14365)
- [A Systematic Evaluation of Imbalance Handling Methods in Biomedical Binary Classification](https://arxiv.org/abs/2605.14147)
- [bde: A Python Package for Bayesian Deep Ensembles via MILE](https://arxiv.org/abs/2605.14146)
...
- [Survival In-Context: Amortized Bayesian Survival Analysis via Prior-Fitted Networks](https://arxiv.org/abs/2603.29475)
- [Self-Driving Datasets: From 20 Million Papers to Nuanced Biomedical Knowledge at Scale](https://arxiv.org/abs/2605.07022)
...
- [Machine-Learning-Enhanced Non-Invasive Testing for MASLD Fibrosis: Shallow-Deep Neural Networks Versus FIB-4, Tabular Foundation Models, and Large Language Models](https://arxiv.org/abs/2605.20523)
...
- [FLOATBench: A Dataset and Benchmark for Floating Offshore Wind Turbine Tower Fatigue](https://arxiv.org/abs/2605.25717)
- [Towards end-to-end LLM-based censoring-aware survival analysis](https://arxiv.org/abs/2605.25399)
...
- [BBOmix: A Tabular Benchmark for Hyperparameter Optimization of Unsupervised Biological Representation Learning](https://arxiv.org/abs/2606.05139)
- [Bayesian learning for the stochastic shortest path problem](https://arxiv.org/abs/2606.04845)
- [UniFair: A unified fair clustering approach based on separation and compactness](https://arxiv.org/abs/2606.04777)
...
- [Bias in Filter Feature Selection Evaluation: A Meta-Analysis of Datasets, Baselines, and Experimental Design Choices](https://arxiv.org/abs/2606.07068)
- [pTNAS: Progressive Neural Architecture Search for Tabular Data](https://arxiv.org/abs/2403.10318)
- [High entropy leads to symmetry-equivariant policies in Dec-POMDPs](https://arxiv.org/abs/2511.22581)
- [Structured Neuron Pruning in Deep Neural Networks Using Multi-Armed Bandits](https://arxiv.org/abs/2606.07615)
- [QDSP: An Interpretable Structured Learning Framework for Predicting Death or Cerebral Palsy in Very Low Birth Weight Infants](https://arxiv.org/abs/2606.07606)
...
- [Predictive Analytics in E-Commerce for CustomerBehavior Forecasting using hybrid Ret-DNN withXGBoost Model](https://arxiv.org/abs/2606.17931)
...
- [RGLD: Randomized Global-Local Density Estimation for Tabular Anomaly Detection](https://arxiv.org/abs/2606.28970)
...
- [Equilibrium Training of Energy-Based Models with Parallel Trajectory Tempering](https://arxiv.org/abs/2607.27077)
...
- [Modeling Decisions in Blockchain Analytics: A Leakage-Aware Evaluation of Tree-Based vs. Sequential Models](https://arxiv.org/abs/2607.27350)
...
- [Flow Matching with Missing Data](https://arxiv.org/abs/2607.28698)
- [Logit-Origin Centering for Singleton Test-Time Adaptation](https://arxiv.org/abs/2608.01074)
- [Generic Vision and Cross-Attention for Reaction Yield Prediction](https://arxiv.org/abs/2608.00776)
- [Ensemble of Unsupervised Deep Learning for Clustering Imbalanced Tabular Data](https://arxiv.org/abs/2608.00346)
- [Deep Reinforcement Learning: From First Principles to Reasoning Models](https://arxiv.org/abs/2608.00133)
- [Test-Time Augmentation for Tabular-to-Image Classifiers under Distribution Shifts](https://arxiv.org/abs/2608.03557)
- [RamanPFN: learning from Raman spectral structure with a tabular foundation model](https://arxiv.org/abs/2608.02157)
- [TS2TabPFN: Time Series Classification and Extrinsic Regression through Feature Extraction and a Tabular Foundation Model](https://arxiv.org/abs/2608.04174)
- [Evaluating Machine Learning Models for Post-Wildfire Debris-Flow Prediction](https://arxiv.org/abs/2608.05265)
- [Tabular Image: a method to convert tabular data to images for convolutional neural networks](https://arxiv.org/abs/2608.07132)
- [ReliableNet: A Chance-Constrained Approach to Trustworthy Classification in Deep Learning](https://arxiv.org/abs/2608.09768)
...
- [TabNSM: Neural Sparse Mixer for Tabular Regression](https://arxiv.org/abs/2608.18026)
- [Diff-DDoS: Realistic Cyber-Physical Attack Synthesis and Robust Detection for 5G-Enabled CPS Using Tabular Diffusion Models](https://arxiv.org/abs/2608.17796)
- [Table2Image: Lightweight Tabular Learning with Generated Proxy Representations and Reliability Diagnostics](https://arxiv.org/abs/2412.06265)
- [Predicting Multiple Clinical Outcomes Related to Functional Recovery and Social Isolation Among Older Adults After Lower-Limb Fracture or Hip Replacement](https://arxiv.org/abs/2608.23531)
...
- [Tabular Deep Learning for Algorithmic Trading: Cross-Regime Bayesian Optimisation for Equity Signal Generation](https://arxiv.org/abs/2608.27076)
...
- [TSPFN: A Temporal Tabular Foundation Model for Physiological Time Series Classification](https://arxiv.org/abs/2608.31013)
- [Relational Task Generation Language: A Declarative Specification Framework for Relational Deep Learning](https://arxiv.org/abs/2609.01292)
- [Solving In-Table Prediction Problems by Deep Neural Networks with Performance Evaluation Using Synthetic Data](https://arxiv.org/abs/2609.01262)
- [Scaling Laws, Tabular Data and Actuarial Ratemaking Models](https://arxiv.org/abs/2609.03106)
...
- [VG-TIE: An interpretable tabular-to-image encoding method based on visibility graphs](https://arxiv.org/abs/2609.29650)
